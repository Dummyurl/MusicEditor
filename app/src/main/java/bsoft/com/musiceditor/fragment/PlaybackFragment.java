...
public class PlaybackFragment extends DialogFragment {
    public static final String ARG_ITEM = "recording_item";
    ...
    private AudioEntity mAudioSave;
    ...
    private Runnable mRunnable = () -> {
        if (mMediaPlayer != null) {
            ...
            mCurrentProgressTextView.setText(Utils.convertMillisecond(mMediaPlayer.getCurrentPosition()));

            updateSeekBar();
        }
    };

    public PlaybackFragment newInstance(AudioEntity item) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAudioSave = getArguments().getParcelable(ARG_ITEM);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mCardView.setCardBackgroundColor(getResources().getColor(R.color.back_ground));
        ...
        mFileNameTextView.setText(mAudioSave.getNameAudio());
        mFileLengthTextView.setText(Utils.convertMillisecond(Long.parseLong(mAudioSave.getDuration())));
    ...
    private void startPlaying() {
        ...
        try {
            mMediaPlayer.setDataSource(mAudioSave.getPath());
