...
//                imgColorUp = Color.WHITE;
    ...
    public TypeGraphBar(Context context, int viewSize) {
        ...
        mSpectrumColors = new int[]{
                Color.argb(MotionEventCompat.ACTION_MASK, 252, 174, 174),
                Color.argb(MotionEventCompat.ACTION_MASK, 252, 146, 146),
                Color.argb(MotionEventCompat.ACTION_MASK, 252, 121, 121),
                Color.argb(MotionEventCompat.ACTION_MASK, 252, 96, 96),
                Color.argb(MotionEventCompat.ACTION_MASK, 252, 68, 68),
                Color.argb(MotionEventCompat.ACTION_MASK, 245, 59, 59),
                Color.argb(MotionEventCompat.ACTION_MASK, 237, 50, 50),
                Color.argb(MotionEventCompat.ACTION_MASK, 230, 39, 39),
                Color.argb(MotionEventCompat.ACTION_MASK,  224, 29, 29),
                Color.argb(MotionEventCompat.ACTION_MASK, 217, 20, 20),
                Color.argb(MotionEventCompat.ACTION_MASK, 209, 10, 10),
                Color.argb(MotionEventCompat.ACTION_MASK, 201, 0, 0),
                Color.argb(MotionEventCompat.ACTION_MASK, 209, 10, 10),
                Color.argb(MotionEventCompat.ACTION_MASK, 217, 20, 20),
                Color.argb(MotionEventCompat.ACTION_MASK, 224, 29, 29),
                Color.argb(MotionEventCompat.ACTION_MASK, 230, 39, 39),
